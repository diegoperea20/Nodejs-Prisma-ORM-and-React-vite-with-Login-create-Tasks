...
#### [Same Project with Backend Flask ](https://github.com/diegoperea20/Flask-React-Login-create-Tasks)

#### [Same Project with Backend Go ](https://github.com/diegoperea20/Go-and-React-vite-with-Login-create-Tasks)
